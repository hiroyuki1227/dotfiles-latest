"use strict";var A=Object.create;var c=Object.defineProperty;var R=Object.getOwnPropertyDescriptor;var T=Object.getOwnPropertyNames;var P=Object.getPrototypeOf,C=Object.prototype.hasOwnProperty;var I=(e,t)=>{for(var n in t)c(e,n,{get:t[n],enumerable:!0})},p=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of T(t))!C.call(e,a)&&a!==n&&c(e,a,{get:()=>t[a],enumerable:!(i=R(t,a))||i.enumerable});return e};var l=(e,t,n)=>(n=e!=null?A(P(e)):{},p(t||!e||!e.__esModule?c(n,"default",{value:e,enumerable:!0}):n,e)),O=e=>p(c({},"__esModule",{value:!0}),e);var M={};I(M,{default:()=>E});module.exports=O(M);var o=require("@raycast/api");var m=l(require("node:process"),1),g=require("node:util"),d=require("node:child_process"),U=(0,g.promisify)(d.execFile);async function u(e,{humanReadableOutput:t=!0,signal:n}={}){if(m.default.platform!=="darwin")throw new Error("macOS only");let i=t?[]:["-ss"],a={};n&&(a.signal=n);let{stdout:_}=await U("osascript",["-e",e,i],a);return _.trim()}var f=require("@raycast/api");var s=l(require("react")),r=require("@raycast/api");var b=require("react/jsx-runtime");var G=!!process.env.RAYCASTX;var w=l(require("fs"));var h=l(require("path"));var L=require("@raycast/api"),N=()=>{if(!process.env.HOME)throw new Error("$HOME environment variable is not set.");return h.default.join(process.env.HOME,"Library")};var y=()=>h.default.join(N(),...$);var W=()=>{try{let e=y(),t=w.default.readFileSync(e,"utf-8"),n=JSON.parse(t).profile.info_cache;return n?Object.keys(n)[0]:"Default"}catch{return"Default"}};var $=["Application Support","Google","Chrome","Local State"],D=W();var k="Google Chrome not installed";var x=async()=>{if(await f.LocalStorage.getItem("is-installed"))return;if(await u(`
