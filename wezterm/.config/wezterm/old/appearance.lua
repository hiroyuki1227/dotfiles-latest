...
local appearance = {
	...
	default_cursor_style = "BlinkingBlock", -- BlinkingBlock, SteadyUnderline, BlinkingUnderline, SteadyBar, BlinkingBar
	-- hide_mouse_cursor_when_typing = true,
	--
	-- -- command palette
	command_palette_font = wezterm.font("SF Pro"),
	...
	--
	-- -- char select
	-- char_select_font = wezterm.font("SF Pro"),
