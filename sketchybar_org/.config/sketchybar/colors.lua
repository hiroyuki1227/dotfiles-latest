local themes = {
	...
	custom = {
		...
		bar = { bg = 0xa024273a, border = 0x2ab0b8cc },
		popup = { bg = 0xff24273a, border = 0xff20def4 },
		bg1 = 0x601f1d2e,
		bg2 = 0x901f1d2e,
	},
}
...
local active_theme = "custom" -- options: "catppuccin", "rose_pine", "rose_pine_moon", "neon", "aurora", "gojo"
